# Copyright (c) 2018 AbsolutelySaurabh
...
func _input(event):
	...
	#means show mouse icon on screen
...
#similar to _process(), called per frame
#but NEEDED must for physics state
...
#contains info about rigit body
func _integrate_forces(state):
	...
	#needed got aiming globally, change state
